...
def main(job,gsd_file_path,frame_number):
    # will use LJ potential with r_cut=2.5
    feneOnly_deformation = True # If True, will not use pair potential, only FENEWCA
    print("Using no pair interactions during deformation of whole system")
    ...
    print("No pair interactions during deformation, using FENEWCA only")
