...
def main():
    ...
    statepoint_grid = {
        ...
        "extender_size":[0],
        "radical_percent":[1.0],
        "chain_side_reaction_probability": [0.1],#0.0,0.5,0.6,0.9],
        ...
        # "polymerization_method":["cpu_local_snapshot","custom_action_GPU","custom_action_CPU","custom_action_GPU_bulk"],
        }
